...
public class Config : MonoBehaviour
{
    ...
    public static void SaveBoardData(SudokuData.SudokuBoardData board_data,string level, int board_index, int error_number,
        Dictionary<string, List<string>> grid_notes)
    {
