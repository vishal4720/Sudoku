...
public class GridSquare : Selectable, IPointerClickHandler, ISubmitHandler, IPointerExitHandler, IPointerUpHandler
{
    ...
    {
        this.has_default_value_ = has_default;
    }

    public bool GetHasDefaultValue() { return this.has_default_value_; }
    ...
    public void SetGridNotes(List<int> notes)
    {
        ...
        {
            SetNoteSingleNumberValue((int)note,true);
        }
    }
